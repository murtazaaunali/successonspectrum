			...
			<div class="col-sm-12">
				<form action="" method="get" id="trip_filters">
					...
					<div class="pull-right">
						...
						<a href="{{ url('femployee/trip_itinerary/edit/') }}" class="btn btn-primary">Clear Filters</a>
					</div>
					<div class="clearfix"></div>
				</form>
			</div>
		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content add-forgetten-modal-content EventModel">
					...
					<form action="{{ url('femployee/trip_itinerary/update') }}" method="post" id="editnewevent">
