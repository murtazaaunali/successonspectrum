        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/femployee/password/reset') }}">
                        {{ csrf_field() }}
                ...
                <div class="col-md-5 col-sm-5 pos-rel-0 mob-login-bg">
                    ...
                    <div class="Login-input">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('personal_email') ?: old('email') }}" placeholder="Email Address" autofocus>
