				    	...
				    	<div class="super-admin-add-relation-main">
				    		...
				    		<div class="super-admin-add-relation">
					    		...
					    		<figure class="pos-rel">
						    		...
						    		<input class="expiration_date" type="text" name="certification[0][expiration_date]" placeholder="mm/dd/yy">
						    		<a class="employe-edit-cal-pos-abs" href="javascript:void(0);"><i class="fa fa-calendar expiration_date" aria-hidden="true"></i></a>
	...
	//Adding validation rules
	 ...
	 $('.add-certification-dashed').click(function(){
	 	var Html = '<div class="super-admin-add-relation mar-top-20px" style="border-bottom: 1px #e3e7ec solid">';
		    	...
		    	Html +=	'<figure class="pos-rel"><label>Expiration Date<span class="required-field">*</span></label><input class="expiration_date" type="text" name="certification['+count+'][expiration_date]" placeholder="mm/dd/yy"><a class="employe-edit-cal-pos-abs" href="javascript:void(0);"><i class="fa fa-calendar expiration_date" aria-hidden="true"></i></a><label class="error error1" for="certification['+count+'][expiration_date]"></label></figure>';
			Html +=	'</div>	';
