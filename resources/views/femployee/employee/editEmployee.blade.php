...
@section('content')
	<div class="add-franchise-super-main">
		...
		<p><a href="#">Employee</a> / Profile Edit</p>
		...
		<div class="add-franchise-data-main-1 add-franchise-data-main-2">
			<div id="franchise-demography" class="tab-pane fade in active">
			    <div class="view-tab-content-main">
			    	...
			    	<form action="{{ url('femployee/edit') }}" method="post" id="editEmployee">
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
			    			<figure>
					    		...
					    		<select name="status">
                                    <option value="1" @if($Employee->personal_status == 'Active') selected="" @endif >Active</option>
					    			<option value="0" @if($Employee->personal_status == 'Terminated') selected= @endif >Terminated</option>
					    			<option value="0" @if($Employee->personal_status == 'Applicant') selected= @endif >Applicant</option>
					    		</select>
				    		</figure>
				    		<figure>
							...
							<figure class="pos-rel">
                                ...
                                <input type="text" name="employee_dob" value="{{ date("m/d/Y",strtotime($Employee->personal_dob)) }}" id="employee_dob" placeholder="mm/dd/yy" class="employee_dob_datepicker">
			    			...
			    			<figure class="pos-rel">
                                ...
                                <input type="text" name="hiring_date" id="hiring_date" value="{{ date('m/d/Y',strtotime($Employee->career_earliest_startdate)) }}" class="hiring_datepicker">
					    	...
					    	<figure class="pos-rel">	
					    		<label>90 Days Probation Completion<span class="required-field">*</span> Date</label>
                                <input type="text" name="completion_date" id="completion_date" value="{{ date('m/d/Y', strtotime($Employee->career_probation_completion_date)) }}" readonly="readonly">
                            ...
                            <div class="radio-btun">
                                <figure>	
                                    ...
                                    <input type="radio" value="Yes" name="career_bacb" @if($Employee->career_bacb == 'Yes') checked @endif class="vartical-top"><span class="vartical-top">&nbsp;Yes</span>&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="No" name="career_bacb" @if($Employee->career_bacb == 'No') checked @endif class="vartical-top"><span class="vartical-top">&nbsp;No</span>
                            ...
                            <div class="radio-btun">
                                <figure>	
                                    ...
                                    <input type="radio" value="Yes" name="career_cpr_certified" @if($Employee->career_cpr_certified == 'Yes') checked @endif class="vartical-top"><span class="vartical-top">&nbsp;Yes</span>&nbsp;&nbsp;&nbsp;
                                    <input type="radio" value="No" name="career_cpr_certified" @if($Employee->career_cpr_certified == 'No') checked @endif class="vartical-top"><span class="vartical-top">&nbsp;No</span>
			    ...
			    <!-- LOGIN DETAILS FORM --> 
			    <form action="{{ url('femployee/invite') }}"  method="post" id="invite_form" autocomplete="off">
			    	<input type="hidden" name="_token" value="{{ csrf_token() }}"/>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('input[name="employee_ss"]').inputmask({"mask": "999-999-9999"});
	...
	function valideEmail(FormName, EmailField, SearchEmailField){
	 ...
	 $('.invite_btn').click(function () {
		valideEmail('#invite_form', 'login_email', 'email');
	 });
});
