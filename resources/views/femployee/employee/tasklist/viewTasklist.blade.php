...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control">
			...
			<p>Employee / <span id="change-bread-crumb">Task List</span></p>
		</div>

		<!--<div class="add-franchise-butn-main">
			<a href="{{ url('franchise/employee/addtasklist/'.$Employee->id) }}" class="btn"><i class="fa fa-plus" aria-hidden="true"></i>Add Task List</a>
		</div>-->
		...
		<div class="add-franchise-data-main-1 PerformanceNone">
			<ul class="nav nav-tabs">
			  ...
			  <a href="{{ url('femployee/view') }}">Employee Demographic</a></li>
