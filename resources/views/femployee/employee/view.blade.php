...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control">
            ...
            <p>Employee / <span id="change-bread-crumb">Employees Demographic</span></p>
		</div>
        ...
        {{--@include('femployee.employee.employeeTop')--}}
		
		<div class="add-franchise-data-main-1 PerformanceNone">
			<ul class="nav nav-tabs EmployeeNavTabs">
			  <li class="padd-left-anchor @if(!Request::get('tab') == 'tasklist') active @endif"><a data-toggle="tab" href="#">Employee Demographic</a></li>
			  <li class="trigger-5 "><a href="{{ url('femployee/viewtasklist') }}">Task List</a></li>
			</ul>
				    ...
				    <div class="view-tab-content-main">
				    	<div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('femployee/edit') }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Details</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
                            ...
                            <figure><h5>Capable Of Performing The Essential Functions Of The Job Which You Are Applying Without Any Accommodations?</h5><h4>{{ $Employee->work_capable }}</h4></figure>
                            @if($Employee->work_capable == 'No')
                            <figure><h5>If No, What Accommodations Do You Need?</h5> @if($Employee->work_nocapable) <h4>{{ $Employee->work_nocapable }}</h4> @endif</figure>
                            @endif
                            <figure><h5>Are you able to lift 30 to 40 lbs? Able to do physical activities?</h5><h4>{{ $Employee->work_liftlbs }}</h4></figure>
				    	...
				    	<div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('femployee/addrelation') }}" class="btn add-franchise-data-butn-1 butn-spacing-padd"><i class="fa fa-user-o" aria-hidden="true"></i>Add Contact</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
				    			...
				    			@if( !$Employee->employee_emergency_contact->isEmpty() )
					    			...
					    			@foreach($Employee->employee_emergency_contact as $e_contact)
						    			<div class="blue-border-box blue-border-box-3 emergency_box">
							    			<a href="{{ url('femployee/editrelation/'.$e_contact->id) }}" class="owner_edit"><i class="fa fa-pencil"></i></a>
							    			<a href="javascript:;" data-contact_id="{{ $e_contact->id }}" class="owner_delete"><i class="fa fa-trash"></i></a>
                        ...
                        <div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('femployee/addcertification') }}" class="btn add-franchise-data-butn-1 butn-spacing-padd"><i class="fa fa-user-o" aria-hidden="true"></i>Add Certification</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
				    			...
				    			@if( !$Employee->employee_certifications->isEmpty() )
					    			...
					    			@foreach($Employee->employee_certifications as $e_certification)
						    			<div class="blue-border-box blue-border-box-3 certification_box">
							    			<a href="{{ url('femployee/editcertification/'.$e_certification->id) }}" class="certification_edit"><i class="fa fa-pencil"></i></a>
							    			<a href="javascript:;" data-certification_id="{{ $e_certification->id }}" class="certification_delete"><i class="fa fa-trash"></i></a>
                        ...
                        <div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('femployee/addcredential') }}" class="btn add-franchise-data-butn-1 butn-spacing-padd"><i class="fa fa-user-o" aria-hidden="true"></i>Add Credential</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
				    			...
				    			@if( !$Employee->employee_login_credentials->isEmpty() )
					    			...
					    			@foreach($Employee->employee_login_credentials as $e_credential)
						    			<div class="blue-border-box blue-border-box-3 credential_box">
							    			<a href="{{ url('femployee/editcredential/'.$e_credential->id) }}" class="credential_edit"><i class="fa fa-pencil"></i></a>
							    			<a href="javascript:;" data-credential_id="{{ $e_credential->id }}" class="credential_delete"><i class="fa fa-trash"></i></a>
				    	...
				    	<div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('femployee/editbenifits') }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Detail</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
	...
	<script type="text/javascript">
        $('document').ready(function(){
            ...
            $('.popup-delete-butn').click(function(){
                window.location.href = '{{ url("femployee/deletecontact") }}'+'/'+contact_id;
            });
            ...
            $('.popup-certification-delete-butn').click(function(){
                window.location.href = '{{ url("femployee/deletecertification") }}'+'/'+certification_id;
            });
            ...
            $('.popup-credential-delete-butn').click(function(){
                window.location.href = '{{ url("femployee/deletecredential") }}'+'/'+credential_id;
            });
