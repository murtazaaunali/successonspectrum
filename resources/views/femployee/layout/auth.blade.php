...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/css/franchisees.css?{{ time() }}">
    ...
    <?php /*?><nav class="navbar navbar-default navbar-static-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <!-- Branding Image -->
                <a class="navbar-brand" href="{{ url('/femployee') }}">
                    {{ config('app.name', 'Laravel Multi Auth Guard') }}: Femployee
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    @if (Auth::guest())
                        <li><a href="{{ url('/femployee/login') }}">Login</a></li>
                        <li><a href="{{ url('/femployee/register') }}">Register</a></li>
                    @else
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a href="{{ url('/femployee/logout') }}"
                                        onclick="event.preventDefault();
                                                 document.getElementById('logout-form').submit();">
                                        Logout
                                    </a>

                                    <form id="logout-form" action="{{ url('/femployee/logout') }}" method="POST" style="display: none;">
                                        {{ csrf_field() }}
                                    </form>
                                </li>
                            </ul>
