...
<html>
  <head>
    <title>@if(isset($page_title)) @if(Auth::guard('franchise')->check()) Admin @endif {{$page_title}} | {{ config('app.name', 'Success on the Spectrum') }} @else {{ config('app.name', 'Laravel Multi Auth Guard') }} @endif</title>
    <meta charset="UTF-8">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-9 col-md-10 col-2 main_right_side">
              ...
              @include('franchise.layout.topbar')
