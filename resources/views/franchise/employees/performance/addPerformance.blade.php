...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control float-none">
			<h6>Micheal Mann</h6>
			<!--<p><a href="{{ url('franchise/employees') }}">Employee</a> / {{ $Employee->fullname }} / Performance Log Add</p>-->
            <p><a href="{{ url('franchise/employees') }}">Employee</a> / {{ $Employee->personal_name }} / Performance Log Add</p>
		</div>
				...
				<div class="franchise-data franchise-data-1 two-butn">
					...
					<ul class="pager wizard two-btn front">
						<li class="previous pull-left">
							<a href="{{ url("franchise/employee/view/".$Employee->id)."?tab=performance_log" }}" style="padding:0px;"><button type="button" class="btn add-franchise-data-butn padd-butn-2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Cancel</button></a>
						</li>
