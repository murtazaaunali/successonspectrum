...
<div class="add-franchise-super-main">
    ...
    <p><a href="#">Client</a> / <a href="{{ url('franchise/client/view/'.$Client->id) }}">{{ $Client->client_childfullname }}</a> Add ABA History</p>
    <div class="add-franchise-data-main-1 add-franchise-data-main-2">
        <div id="franchise-demography" class="tab-pane fade in active">
            <div class="view-tab-content-main">
                <form action="{{ url('franchise/client/viewmedicalinformation/storeabahistory/'.$Client->id) }}" method="post" id="addABAHistory">
