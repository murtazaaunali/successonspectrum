...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control">
            ...
            <p>Client / {{ $Client->client_childfullname }} / <span id="change-bread-crumb">Medical Information</span></p>
		</div>
		...
		<div class="add-franchise-data-main-1 PerformanceNone">
            ...
            <!--<ul class="nav nav-tabs ClientNavTabs">
			  ...
			  <li class="trigger padd-left-anchor active"><a href="#">Medical Information</a></li>
				    ...
				    <div class="view-tab-content-main">
				    	<div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			...
				    			<a href="{{ url('franchise/client/uploadreport/'.$Client->id) }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Upload New Report</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
                                	...
                                	@foreach($Client->documents as $doc)
                                        ...
                                        <div class="super-admin-cargo-hold-box dropdown">
                                            ...
                                            <div class="logout-box-main dropdown-menu" aria-labelledby="dropdownMenuButton4">
                                                <a href="{{ url('franchise/client/downloadmedicaldocuments/'.$Client->id.'/'.$doc->id) }}" class="head-active">Download</a>
                                                <form action="{{ url('franchise/client/archivemedicaldocuments/'.$Client->id.'/'.$doc->id) }}" method="post">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                                                    <a href="javascript:void(0);" class="archive_client_medicaldocument">Archive</a>
                                                </form>
                                                <form action="{{ url('franchise/client/deletemedicaldocuments/'.$Client->id.'/'.$doc->id) }}" method="post">
                                                    <input type="hidden" name="_token" value="{{ csrf_token() }}" >
                            ...
                            <!--@if($Client->client_childiep != '')
	                            ...
	                            <div class="super-admin-cargo-hold-box dropdown">
	                                <button class="dropdown-toggle" type="button" id="dropdownMenuButton4" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">...</button>
	                                <div class="logout-box-main dropdown-menu" aria-labelledby="dropdownMenuButton4">
	                                    <a href="{{ url('franchise/client/downloadmedicaldocuments/client_childiep/'.$client_childiep.'/'.$Client->id) }}" class="head-active">Download</a>
	                                    <form action="{{ url('franchise/client/archivemedicaldocuments/client_childiep/'.$client_childiep.'/'.$Client->id) }}" method="post">
	                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
	                                        <a href="javascript:void(0);" class="archive_client_medicaldocument">Archive</a>
	                                    </form>
	                                    ...
	                                    <form action="{{ url('franchise/client/deletemedicaldocuments/client_childiep/'.$client_childiep.'/'.$Client->id) }}" method="post">
	                                        <input type="hidden" name="_token" value="{{ csrf_token() }}" >
	                                        <a href="javascript:void(0);" class="bord-bot-0 red-clr delete_client_medicaldocument">Delete</a>
	                                    </form>
                            ...
                            <div class="clearfix">&nbsp;</div>
				    		<figure><h5><!--Describe The Age-->First Symptoms</h5><h4>{{ $Client->client_ageandsymtoms }}</h4></figure>
                            <figure>
                            ...
                            <div class="clearfix">&nbsp;</div>
                            <a href="{{ url('franchise/client/viewmedicalinformation/addabahistory/'.$Client->id) }}" class="btn add-franchise-data-butn-1 pull-right"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Add ABA History</a>
                            <div class="clearfix">&nbsp;</div>
                            @php
	                            $facility_count = 1;
	                            $client_aba_facilities = unserialize($Client->client_aba_facilities);
                                //print_r($client_aba_facilities);exit();
                            @endphp
                            ...
                            <!--<a href="{{ url('franchise/client/viewmedicalinformation/editabahistory/'.$Client->id) }}" class="owner_edit abahistory_action_icon abahistory_edit" title="Edit ABA History"><i class="fa fa-pencil"></i></a>-->
                            <a class="owner_delete">{{ $key+1 }}</a>
                            <!--<a href="javascript:;" data-abahistory_id="7" data-client_id="{{ $Client->id }}" class="owner_delete abahistory_action_icon abahistory_delete" title="Delete ABA History"><i class="fa fa-trash"></i></a>-->
                            ...
                            <?php /*?><figure><h5>How Many Hours of ABA Did They Receive Per Week</h5><h4>{{ $Client->client_medicalabahoursperweek }}</h4></figure>
                            ...
                            <figure><h5>Address</h5><h4>{{ $Client->client_medicaladdress }}</h4></figure><?php */?>
	...
	<script type="text/javascript">
        $('document').ready(function(){
			...
			$('.archive_client_medicaldocument').click(function () {
				$(this).parent().submit();
			});
