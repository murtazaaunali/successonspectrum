...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control">
            ...
            <p>Client / {{ $Client->client_childfullname }} / <span id="change-bread-crumb">Client Information</span></p>
		</div>
				    ...
				    <div class="view-tab-content-main">
				    	<div class="view-tab-content-head-main">
				    		...
				    		<div class="view-tab-content-butn">
				    			<a href="{{ url('franchise/client/edit/'.$Client->id) }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Details</a>
				    		</div>
				    		<div class="clearfix"></div>
				    	</div>
				    	<div class="view-tab-content">
                            ...
                            <figure class="hidden"><h5>Custodial Parent's Address</h5><h4>{{ $Client->client_custodialparentsaddress }}</h4></figure>
