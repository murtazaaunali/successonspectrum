			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_insurancepayerid" value="{{ $ClientInsurancePolicy->client_insurancepayerid }}" maxlength="8">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_insurancephone_number" value="{{ $ClientInsurancePolicy->client_insurancephone_number }}">
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
							...
							<figure class="pos-rel">
                                ...
                                <?php /*?><input type="text" name="client_authorizationsparenttraining" value="@if($Client->client_authorizationsparenttraining != "" && $Client->client_authorizationsparenttraining != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_authorizationsparenttraining)) }}@endif" id="client_authorizationsparenttraining" placeholder="mm/dd/yy" class="client_authorizationsparenttraining"><?php */?>
                                <input type="text" name="client_authorizationsparenttraining" value="{{ $Client->client_authorizationsparenttraining }}" id="client_authorizationsparenttraining">
                            ...
                            <figure class="pos-rel">
                                ...
                                <?php /*?><input type="text" name="client_authorizationsreassessment" value="@if($Client->client_authorizationsreassessment != "" && $Client->client_authorizationsreassessment != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_authorizationsreassessment)) }}@endif" id="client_authorizationsreassessment" placeholder="mm/dd/yy" class="client_authorizationsreassessment"><?php */?>
                                <input type="text" name="client_authorizationsparenttraining" value="{{ $Client->client_authorizationsparenttraining }}" id="client_authorizationsparenttraining">
