...
@section('content')
	<div class="add-franchise-super-main">
		...
		<p><a href="#">Client</a> / <a href="{{ url('franchise/client/view/'.$Client->id) }}">{{ $Client->client_childfullname }}</a> @if(!empty($ClientInsurancePolicy->client_insurancename))/ <a href="{{ url('franchise/client/viewinsurance/'.$Client->id.'/'.$ClientInsurancePolicy->id) }}">{{ $ClientInsurancePolicy->client_insurancename }}</a> /@endif Add Authorization</p>
		<div class="add-franchise-data-main-1 add-franchise-data-main-2">
			<div id="franchise-demography" class="tab-pane fade in active">
			    <div class="view-tab-content-main">
			    	<form action="{{ url('franchise/client/viewinsurance/storeauthorization/'.$Client->id.'/'.$ClientInsurancePolicy->id) }}" method="post" id="addAuthorization">
			    	...
			    	<div class="view-tab-content-head-main view-tab-content-head-main-3">
			    		...
			    		<div class="view-tab-content-butn">
			    			<button type="submit" class="btn add-franchise-data-butn-1"><i class="fa fa-check" aria-hidden="true"></i>Save Authorization</button>
			    		</div>
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
							...
							<figure class="pos-rel">
                                ...
                                <?php /*?><input type="text" name="client_authorizationsparenttraining" value="" id="client_authorizationsparenttraining" placeholder="mm/dd/yy" class="client_authorizationsparenttraining">
					    		<a class="employe-edit-cal-pos-abs" href="javascript:void(0);"><i class="fa fa-calendar client_authorizationsparenttraining" aria-hidden="true"></i></a><?php */?>
