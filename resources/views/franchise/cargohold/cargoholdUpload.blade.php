			    	...
			    	<div class="row">
				    	...
				    	<div class="col-md-3">
					    	<select class="category" name="category">
					    		<option @if( $category == 'Personal Documents' ) selected @endif>Personal Documents</option>
					    		<option @if( $category == 'Employee Training' ) selected @endif>Employee Training</option>
					    		<option @if( $category == 'Parent Training' ) selected @endif>Parent Training</option>
					    		<option @if( $category == 'SOS Employee Forms' ) selected @endif>SOS Employee Forms</option>
					    		<option @if( $category == 'SOS Parent Forms' ) selected @endif>SOS Parent Forms</option>
					    		<option @if( $category == 'SOS Reports' ) selected @endif>SOS Reports</option>
					    	</select>
				    	</div>
			    	</div>
			    </div>
			    	...
			    	<div class="row">
				    	...
				    	<div class="col-md-3">
					    	<div class="franchise-data-check-box">
                                ...
                                <b><input class="wid-auto" name="user_type[]" type="checkbox" value="Franchise" checked ><span>Franchise</span></b>
