  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    var calendar = new FullCalendar.Calendar(calendarEl, {
	  ...
	  eventClick: function(info) {
	    ...
	    date = (month < 10 ? 0+""+month : month )+'/'+ date.getDate() +'/'+date.getFullYear()  ;
	    ...
	    $('input[name=franchise_id]').val(ids[1]);
			...
			<div class="col-sm-12">
				<form action="" method="get" id="trip_filters">
					...
					<div class="pull-right">
						...
						<a href="{{ url('franchise/trip_itinerary/edit/') }}" class="btn btn-primary">Clear Filters</a>
					</div>
					<div class="clearfix"></div>
				</form>
			</div>
		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content add-forgetten-modal-content EventModel">
					...
					<form action="{{ url('franchise/trip_itinerary/update') }}" method="post" id="editnewevent">
