		...
		<div class="modal fade" id="myModal" role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content add-forgetten-modal-content EventModel">
					...
					<form action="{{ url('franchise/trip_itinerary/add') }}" method="post" id="addnewevent">
	...
	<div class="upcoming-contact-expiration franchise-list-main TripItineraryMainDiv">
		...
		<div class="view-tab-content-head-main">
    		...
    		<div class="view-tab-content-butn">
    			<!--<a href="{{ url('franchise/trip_itinerary/edit') }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Details</a>-->&nbsp;
    		</div>
    		<div class="clearfix"></div>
    	</div>
			...
			<div class="col-sm-12">
				<form action="" method="get" id="trip_filters">
					<div class="super-admin-table-select col-sm-9">
						...
						<div class="super-admin-table-select-calender-icon TripItineraryViewCalendar" style="left:20%;">
					...
					<div class="pull-right">
						...
						<a href="{{ url('franchise/trip_itinerary') }}" class="btn francse-filter-butn butn-spacing-padd-1"><i class="fa fa-filter" aria-hidden="true"></i>Clear Filters</a>
					</div>
					<div class="clearfix"></div>
				</form>
			</div>
