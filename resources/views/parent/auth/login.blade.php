        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/parent/login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-8 col-md-offset-4">
                                ...
                                <a class="btn btn-link" href="{{ url('/parent/password/reset') }}">
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-sm-5 pos-rel-0 mob-login-bg">
                ...
                <div class="forget-pasmain">
                    <a class="btn btn-link" href="{{ url('/parent/password/reset') }}"><i class="fa fa-lock" aria-hidden="true"></i> Forgot Your Password?</a>
                </div>
            </div>
        </div>
    </form>	
