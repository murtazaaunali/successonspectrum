        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/parent/password/email') }}">
                        {{ csrf_field() }}
				...
				<div class="row">
					...
					<div class="col-md-5 col-sm-5 pos-rel-0 mob-login-bg">
						...
						<div class="Login-input">
                            ...
                            <input id="email" type="email" name="email" value="{{ old('email') }}" placeholder="Registered Email Address">
						...
						<div class="forget-pasmain ForgetPassTextAlign">
							<a href="{{ url('parent/login') }}"><i class="fa fa-lock" aria-hidden="true"></i> Remember your login details?</a><a href="#">Login</a>
						</div>
					</div>
				</div>
			</form>
