...
@section('content')
	<div class="add-franchise-super-main">
		...
		<p>@if($router_name != 'parent.editinsurance')<a href="#">Client</a> / @endif<a href="#">Edit Insurance</a></p>
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
				    		<figure>
                                ...
                                <input type="text" name="client_insurancecompanyname" value="{{ $Client->client_insurancecompanyname }}">
					    		<label class="error error1" for="client_insurancecompanyname"></label>
					    	</figure>
                            <figure>
                                <label>Member ID<span class="required-field">*</span></label>
                                <input type="text" name="client_memberid" value="{{ $Client->client_memberid }}">
					    		<label class="error error1" for="client_memberid"></label>
					    	</figure>
                            <figure>
                                <label>Group ID<span class="required-field">*</span></label>
                                <input type="text" name="client_groupid" value="{{ $Client->client_groupid }}">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_policyholdersname" value="{{ $Client->client_policyholdersname }}">
							...
							<figure class="pos-rel">
                                ...
                                <input type="text" name="client_policyholdersdateofbirth" value="@if($Client->client_policyholdersdateofbirth != "" && $Client->client_policyholdersdateofbirth != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_policyholdersdateofbirth)) }}@endif" id="client_policyholdersdateofbirth" placeholder="mm/dd/yy" class="client_policyholdersdateofbirth">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_subscribername" value="{{ $Client->client_subscribername }}">
					    		<label class="error error1" for="client_subscribername"></label>
					    	</figure>
                            <figure class="pos-rel">
					    		<label>Subscriber's DOB<span class="required-field">*</span></label>
                                <input type="text" name="client_subscriberdateofbirth" value="@if($Client->client_subscriberdateofbirth != "" && $Client->client_subscriberdateofbirth != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_subscriberdateofbirth)) }}@endif" id="client_subscriberdateofbirth" placeholder="mm/dd/yy" class="client_subscriberdateofbirth">
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
				    		<figure class="pos-rel">
                                ...
                                <input type="text" name="client_benefiteffectivedate" value="@if($Client->client_benefiteffectivedate != "" && $Client->client_benefiteffectivedate != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_benefiteffectivedate)) }}@endif" id="client_benefiteffectivedate" placeholder="mm/dd/yy" class="client_benefiteffectivedate">
                            ...
                            <figure class="pos-rel">
                                ...
                                <input type="text" name="client_benefitexpirationdate" value="@if($Client->client_benefitexpirationdate != "" && $Client->client_benefitexpirationdate != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_benefitexpirationdate)) }}@endif" id="client_benefitexpirationdate" placeholder="mm/dd/yy" class="client_benefitexpirationdate">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_benefitcopay" value="{{ $Client->client_benefitcopay }}">
					    		<label class="error error1" for="client_benefitcopay"></label>
					    	</figure>
                            <figure>
                                <label>OOPM<span class="required-field">*</span></label>
                                <input type="text" name="client_benefitoopm" value="{{ $Client->client_benefitoopm }}">
					    		<label class="error error1" for="client_benefitoopm"></label>
					    	</figure>
                            <figure>
                                <label>Annual Benefit<span class="required-field">*</span></label>
                                <input type="text" name="client_benefitannualbenefit" value="{{ $Client->client_benefitannualbenefit }}">
					    		<label class="error error1" for="client_benefitannualbenefit"></label>
					    	</figure>
                            <figure>
                                <label>Claim's Address<span class="required-field">*</span></label>
                                <input type="text" name="client_benefitclaimaddress" value="{{ $Client->client_benefitclaimaddress }}">
					    		<label class="error error1" for="client_benefitclaimaddress"></label>
					    	</figure>
							<figure class="pos-rel">
					    		<label>Date Verified<span class="required-field">*</span></label>
                                <input type="text" name="client_benefitdateverified" value="@if($Client->client_benefitdateverified != "" && $Client->client_benefitdateverified != '0000-00-00'){{ date("m/d/Y",strtotime($Client->client_benefitdateverified)) }}@endif" id="client_benefitdateverified" placeholder="mm/dd/yy" class="client_benefitdateverified">
                            ...
                            <figure>
                                ...
                                <input type="text" name="client_benefitinsuranceemployee" value="{{ $Client->client_benefitinsuranceemployee }}">
                            ...
                            <figure>	
                                ...
                                <input type="phone" name="client_benefitreferencenumber" value="{{ $Client->client_benefitreferencenumber }}" placeholder="xxx-xxx-xxxx">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('input[name=client_benefitreferencenumber]').inputmask({"mask": "999-999-9999"});
		...
		$("#editBenefits").validate({
			rules:{
				...
				client_benefitcopay:{required:true},
				client_benefitoopm:{required:true},
				client_benefitannualbenefit:{required:true},
				...
				client_benefitreferencenumber:{required:true, phoneUS:true, usphonenumb:true},
			},
		});
