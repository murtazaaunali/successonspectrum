...
@section('content')
	<div class="add-franchise-super-main">
		...
		<p><a href="#">Client </a> / Edit Medical Information</p>
			    ...
			    <div class="view-tab-content-main">
			    	...
			    	<div class="super-admin-add-relation-main">
			    		<div class="super-admin-add-relation border-bot-0">
				    		<figure>
                                <label class="vartical-top">Describe The Age<span class="required-field">*</span></label>
                            ...
                            <figure>	
					    		<label>Secondary Diagnosis, if any<span class="required-field">*</span></label>
                            ...
                            <figure>	
                                <label></label>
                                <input class="btn add-relation-dashed add-client-aba-fields" type="button" value="+ Add">
                            </figure>
                            <div class="radio-btun">
                                <figure>	
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('input[name=client_medicalfaxnumber]').inputmask("000-000-0000");
		$('input[name=client_medicalphonenumber]').inputmask("000-000-0000");
		...
		$("#editMedicalInformation").validate({
			rules:{
				...
				client_secondarydiagnosis:{required:true},
				client_childcurrentmedications:{required:true},
				client_medicalphonenumber:{required:true, phoneUS:true, usphonenumb:true},
				client_medicalfaxnumber:{required:true, phoneUS:true, usphonenumb:true},
	...
	function checkClientSpeechTherapyRadioOption()
	{
		if($('input[name=client_speechtherapy]:checked').val() == "Yes")
		{
			...
			$("input[name='client_speechhoursweek']").each(function(){$(this).rules("add", {required:true});$(this).removeAttr('disabled'); });
		}
		else
		{
	...
	function checkClientOccupationalTherapyRadioOption()
	{
		if($('input[name=client_occupationaltherapy]:checked').val() == "Yes")
		{
			...
			$("input[name='client_occupationalhoursweek']").each(function(){$(this).rules("add", {required:true});$(this).removeAttr('disabled'); });
		}
		else
		{
