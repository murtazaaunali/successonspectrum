...
@section('content')
	...
	@if(Session::has('Success'))
		{!! session('Success') !!}
	@endif
	<form method="GET" action="{{ route('parent.trip_itinerary') }}" id="trip_itinerary_search">
		<div class="frnchise-select-main">
			...
			<div class="fiter-butn-main">
				...
				<a href="{{ route('parent.trip_itinerary')  }}@if(Request::has('page'))?page={{ Request::get('page')  }}@endif" class="btn francse-filter-butn  butn-spacing-padd-1"><i class="fa fa-filter" aria-hidden="true"></i>Clear Filter</a>
			</div>
		</div>
	</form>
