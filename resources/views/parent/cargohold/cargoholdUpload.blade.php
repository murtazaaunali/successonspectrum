			    	...
			    	<div class="row">
				    	...
				    	<div class="col-md-3">
					    	<!--<select class="category" name="category">
					    		<option @if( $category == 'Perosnal Documents' ) selected @endif value="Perosnal Documents">Documents</option>
					    		<option @if( $category == 'SOS Reports' ) selected @endif value="SOS Reports">SOS Reports</option>
					    	</select>-->
					    	<input type="hidden" name="category" value="Perosnal Documents"/>
				    	</div>
			    	</div>
			    </div>
			    <div class="franchise-data hidden">
			    	<div class="row">
				    	...
				    	<div class="col-md-3">
					    	<div class="franchise-data-check-box">
                                ...
                                <b><input class="wid-auto" name="user_type[]" type="checkbox" value="Parent" checked ><span>Parent</span></b>
					...
					<div class="drop">
					    <div class="cont">
					    	...
					    	<div class="upload-para">
					    		<p>Drag and drop a file or click here<span class="required-field">*</span></p>
					    	</div>
					    </div>
