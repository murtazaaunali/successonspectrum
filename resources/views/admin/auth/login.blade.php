			...
			{{ csrf_field() }}
				<div class="row">
					...
					<div class="col-md-5 col-sm-5 pos-rel-0 mob-login-bg">
						<div class="logo-login logo-admin-login">
							<!--<img src="{{ asset('assets') }}/images/login-admin-logo.png">-->
						...
						<div class="login-head">
							...
							<div class="Login-input">
                                ...
                                @endif
								<!--<a href="main-deck-super-admin.php" class="btn login-butn">LOGIN</a>-->
								<button type="submit" class="btn login-butn">Login</button>
							</div>
						
						<div class="forget-pasmain">
							<a class="btn btn-link" href="{{ url('/admin/password/reset') }}"><i class="fa fa-lock" aria-hidden="true"></i> Forgot Your Password?</a>
							<!--<a href="forgot-pass.php"><i class="fa fa-lock" aria-hidden="true"></i> Forgot your password?</a>-->
						</div>
					</div>
				</div>
