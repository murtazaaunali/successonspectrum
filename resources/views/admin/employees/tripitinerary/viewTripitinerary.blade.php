...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control">
			...
			<p>Employee / {{ $Employee->fullname }} / <span id="change-bread-crumb">Trip Itinerary</span></p>
		...
		<div class="add-franchise-data-main-1 PerformanceNone">
			<ul class="nav nav-tabs">
			  ...
			  <li class="trigger active"><a href="#" >Trip Itinerary</a></li>
                    ...
                    @endif
                        <div class="view-tab-content-head-main view-tab-content-head-main-padd">
                            ...
                            <div class="view-tab-content-butn">
                                ...
                                @else
                                    <a href="{{ url('admin/employee/viewtripitinerary/'.$Employee->id.'?trip_itenary=edit') }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Details</a>
                                @endif
