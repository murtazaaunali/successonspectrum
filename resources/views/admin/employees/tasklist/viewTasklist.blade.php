				...
				<div id="task-list" class="tab-pane fade in active">
					<div class="view-tab-content-head-main">
					    		...
					    		<div class="view-tab-content-butn">
					    			<a href="{{ url('admin/employee/addtasklist/'.$Employee->id) }}" class="btn add-franchise-data-butn-1"><i class="fa fa-plus" aria-hidden="true"></i>Add To Task List</a>
					    			<a href="{{ url('admin/employee/edittasklist/'.$Employee->id) }}" class="btn add-franchise-data-butn-1"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit Details</a>
					    		</div>
					    		<div class="clearfix"></div>
					    	</div>
