...
@section('content')
	...
	<div class="add-franchise-super-main">
		<div class="view-tab-control float-none">
			<h6>{{ $sub_title }}</h6>
			<p><a href="{{ url('admin/catalogue') }}">Catalog </a> / Add New Products</p>
		</div>
		...
		<div class="upcoming-contact-expiration franchise-list-main upload-document-cargo-upload CatalogAddProductMain">
			...
			<div class="add-employee-data Padd-left-7">
				    ...
				    <div class="franchise-data">
				    	<div class="ad-product-label-input-main AddAttributeStyle">
				    		<label class="float-l">Add Attribute</label>
				    		<div class="AddProductInput">
				    			<input type="text" name="attr">
				    			<a href="javascript:;" class="btn add-franchise-data-butn padd-butn-2 add_attr">Add</a>
				    ...
				    <div class="franchise-data franchise-data-1 add-pro-data-butn">
				    	<div class="product_gallery"></div>
				    	<div class="product_image"></div>
				    	<button type="submit" class="btn add-franchise-data-butn padd-butn-2"><i class="fa fa-building" aria-hidden="true"></i>Add Product</button>
				    </div>
				    <div class="clearfix"></div>
			</div>
			</form>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(document).on('click','.remove-butn',function(){
			$(this).parent('.attr_removeDiv').remove();
		});
