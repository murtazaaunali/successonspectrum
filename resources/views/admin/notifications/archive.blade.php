...
@section('content')
	<div class="add-franchise-super-main">
		...
		<div class="msg-in-a-bottle-head-top-butn msg-btn-pos msg-in-a-bottle-head-top">
			<a href="{{ url('admin/notifications') }}" class="btn grey-clr-butn-msg" style="background: #4e98ca ; "><i class="fa fa-bell" aria-hidden="true"></i>Notifications </a>
						...
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-footer">
									<a href="{{ route('admin.remove_archive',['id'=>$notification->id]) }}" class="btn btn-primary">Yes, Continue</a>
