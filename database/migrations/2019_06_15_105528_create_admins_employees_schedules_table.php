...
class CreateAdminsEmployeesSchedulesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('admins_employees_schedules', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('admins_employees_schedules');
    }
}
