...
class SAdminFranchiseLocalAdvertisements extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SA:FranchiseLocalAdvertisements';
     ...
     * @var string
     */
    protected $description = 'Command for checking franchise local advertisements';
