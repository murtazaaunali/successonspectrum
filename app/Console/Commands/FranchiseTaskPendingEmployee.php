...
class FranchiseTaskPendingEmployee extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'FR:TaskPendingEmployee';
     ...
     * @var string
     */
    protected $description = 'This command is for checking which franchise employee have pending tasks.';
