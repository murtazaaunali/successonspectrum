...
class SAdminFranchiseInsurance extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'SA:FranchiseInsurance';
     ...
     * @var string
     */
    protected $description = 'Command for checking franchise required insurance';
