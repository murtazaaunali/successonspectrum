...
class TripItineraryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        */
        ...
        $getEvents = Admins_events::when($request->year, function($query, $year){
    ...
    {
        $addEvent = new Admins_events();
        $addEvent->admin_employee_id= $request->selectadmin;
    ...
    {
        $editEvent = Admins_events::find($request->event_id);
        $editEvent->admin_employee_id	= $request->admin_employee_id;
